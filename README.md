...
Note that to use it you'll have to build it (Visual Studio recommended), open .csproj, save the solution, right-click it, click at 'restore nuget packages' and build!
